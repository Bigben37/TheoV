...
\end{figure}
    ...
    \begin{enumerate}[i)]
        ...
        \begin{equation}
            ...
            \end{split}
        \end{equation}
        TODO Bild Bose/Einstein Kondensat $N_0/N$ über $T_c$\\
        ...
        \end{equation}
        TODO Bild: $\lambda$-Übergang in Helium \\ %TODO Bild
...
\begin{enumerate}[A)]
    ...
    Anfang 3.6: %TODO Ref Kapitel 3.6
    \begin{equation}
    ...
    \underline{Idee}: von Einstein (bereits besprochen): Das Gitter wird als eine Ansammlung von $3N$ nicht wechselwirkenden  %TODO Ref
