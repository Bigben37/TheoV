...
\end{figure}
    ...
    \begin{table}
        \begin{tabular}{|c|c|c|c|c|c|}
            \hline
            & \multicolumn{3}{|c|}{Modelle} & \multicolumn{2}{|c|}{Messungen} \\ \hline
            Exp. & MFA & Ising(2D) & Ising(3D) & magnetisch & Gas-flüssig-Übergang \\ \hline
            $\alpha$ & diskontinuierlich & $\mathcal{O}(\ln)$ & 0.11 & $\mathcal{O}(\ln)$ & $\mathcal{O}(\ln)$ \\ \hline
            $\beta$ & 1/2 & 1/8 & 0.325 & 0.34-0.37 & 0.33-0.36 \\ \hline
            $\gamma$ & 1 & 7/4 & 1.2402 & 1.29-1.31 & >1.1 \\ \hline
            $\delta$ & 3 & 15 & 4.816 & 4.2 & 4.2 \\ \hline
            $\nu$ & 1/2 & 1 & 0.630 & 0.68 & - \\ \hline
        \end{tabular}
        \caption{Theoretische und gemessene Werte der kritischen Exponenten.}
        \label{tab:critExponents}
    \end{table}
