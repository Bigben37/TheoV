...
\begin{figure}[H]
        ...
        \input{../img/pV-pT.pdf_tex}
        \caption{Phasenübergänge im $p$-$T$- und im $p$-$V$-Diagramm.}
        \label{img:pV-pT}
\end{figure}
...
\begin{figure}[H]
        \centering
        \def\svgwidth{0.5\textwidth}
        \input{../img/UvanderWaals.pdf_tex}
...
\begin{figure}[H]
        \centering
        \def\svgwidth{0.5\textwidth}
        \input{../img/pV-vanderWaals.pdf_tex}
        \caption{$p$-$V$-Diagramm für das van-der-Waals-Gas.}
        \label{img:label}
\end{figure}
...
\begin{figure}[H]
        \centering
        \def\svgwidth{0.5\textwidth}
        \input{../img/pV-path.pdf_tex}
        \caption{Reversibler Kreisprozess im $p$-$V$-Diagramm.}
        \label{img:pV-path}
\end{figure}

Vorschrift: reversibler Kreisprozess entlang des gezeichneten Weges in \autoref{img:pV-path}
\begin{equation}
    \begin{split}
    ...
    \end{split}
\end{equation}
$\Rightarrow$ Gleichheit der blauen Flächen! $\Rightarrow$ Festlegung von $p$, d.h. im Allgemeinem von $p(T)$
...
Zur Vereinfachung: eindimensional (siehe \autoref{eq:work_mag}) $M = V M_0 = V \chi H$ (extensiv)
\begin{equation}
...
\begin{figure}[H]
        ...
        \input{../img/paramag_Tto0_2.pdf_tex}
...
\begin{figure}[H]
        \centering
        \def\svgwidth{0.5\textwidth}
        \input{../img/H-T_supercond.pdf_tex}
        \caption{$H$-$T$-Diagramm eines Supraleiters 1. Art.}
        \label{img:H-T_supercond}
\end{figure}
...
\begin{enumerate}[i)]
    ...
    \item Mit der Entropiedifferenz geht einher die latente Wärme $\delta Q = T \left( S_\text{N} - S_\text{SL} \right) $
